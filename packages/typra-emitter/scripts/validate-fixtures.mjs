...
function runTypeScriptExecutableConformance() {
  ...
  writeFileSync(runnerPath, [
    'import { FixtureConnection, FixtureContent, FixtureNamedPayloadCollection, FixtureNamedRoot, FixtureReference, FixtureRoot, SaveContext, WireOptions } from "./index";',
    "",
...
function runPythonExecutableConformance() {
  ...
  const runner = [
    ...
    "from python import FixtureCheckpoint, FixtureConnection, FixtureContent, FixtureNamedPayloadCollection, FixtureNamedRoot, FixtureReference, FixtureRoot, LoadContext, ModelInfo, SaveContext, WireOptions",
...
function runCSharpExecutableConformance() {
  ...
  writeFileSync(programPath, [
    ...
    'var functionTool = FixtureFunctionTool.Load(new Dictionary<string, object?> { ["kind"] = "function", ["name"] = "convert", ["command"] = "convert", ["bindings"] = new Dictionary<string, object?> { ["unit"] = new Dictionary<string, object?> { ["source"] = "preferred_unit" } } });',
