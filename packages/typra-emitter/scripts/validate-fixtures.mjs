...
function runPrettierOverTree(dir) {
...
function runRuffFormatOverTree(dir) {
  execFileSync(
    "uv",
...
function runGoogleJavaFormatOverTree(dir) {
...
const MEASURE_DEFERRED_IDEMPOTENCY =
 ...
 */
function runIdempotencyGuard(target, context) {
