...
function runTypeScriptExecutableConformance() {
  ...
  writeFileSync(runnerPath, [
    ...
    'const wildcardTool = FixtureTool.load({ kind: "vendor", name: "vendor", description: "vendor description", config: { enabled: true } });',
...
function runPythonExecutableConformance() {
  ...
  const runner = [
    ...
    'wildcard_tool = FixtureTool.load({"kind": "vendor", "name": "vendor", "description": "vendor description", "config": {"enabled": True}})',
...
function runGoExecutableConformance() {
  ...
  writeFileSync(runnerPath, [
    ...
    '\twildcardToolInput := map[string]interface{}{"kind": "vendor", "name": "vendor", "description": "vendor description", "config": map[string]interface{}{"enabled": true}}',
...
function runRustExecutableConformance() {
  ...
  writeFileSync(runnerPath, [
    ...
    '    let wildcard_tool_input = json!({"kind": "vendor", "name": "vendor", "description": "vendor description", "config": {"enabled": true}});',
...
function runCSharpExecutableConformance() {
  ...
  writeFileSync(programPath, [
    ...
    'var wildcardToolInput = new Dictionary<string, object?> { ["kind"] = "vendor", ["name"] = "vendor", ["description"] = "vendor description", ["config"] = new Dictionary<string, object?> { ["enabled"] = true } };',
...
function runJavaExecutableConformance() {
  ...
  writeFileSync(runnerPath, [
    ...
    '    Map<String, Object> wildcardToolInput = new LinkedHashMap<>(Map.of("kind", "vendor", "name", "vendor", "description", "vendor description", "config", Map.of("enabled", true)));',
