...
public struct FixtureRoot: TypraModel {
  ...
  public var contentItems: [FixtureContent] = []
  ...
  public static func load(_ data: Any, context: LoadContext = LoadContext()) throws -> FixtureRoot {
    ...
    if let value = object["contentItems"] {
      instance.contentItems = try TypraRuntime.array(value, field: "contentItems").map { try FixtureContent.load($0, context: context) }
    }
    return instance
  }
}
