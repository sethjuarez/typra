...
Some existing Typra contracts may describe callable seams with model-level
decorators. Convert those declarations to TypeSpec-native interfaces and
operations before adding new coverage.
