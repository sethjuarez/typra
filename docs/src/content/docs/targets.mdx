...
| `Java` | Models with load, save, `fromJson`, `toJson`, scalar coercion, enum handling, polymorphic dispatch, and tests. |
...
| `CSharp`, `Java` | JSON-oriented model surfaces; confirm package/namespace conventions before publishing generated output. |
