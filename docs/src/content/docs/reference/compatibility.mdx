...
Target support is evidence-driven. The fixture suite validates generated compile/test surfaces across TypeScript, Python, C#, Go, Java, Rust, Swift, Markdown, and JSON AST generation.
...
| Swift | SwiftPM package with JSON/YAML helpers; build and test require a Swift toolchain (gated by `CI_SWIFT_REQUIRED`). |
