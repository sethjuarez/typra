---
title: Roadmap
description: Typra roadmap for principle-led contract projection, consumer compatibility, and conformance evidence.
draft: false
---

Typra moves toward an agent drift prevention layer: TypeSpec is the
...
If this reveals a better way to build Prompty with Typra, that is a valid
success path, not a regression.

## Contract projection roadmap

1. Define the [Typra contract vocabulary and migration rules](/concepts/contracts/).
